...
class ProjectMetricsServiceImplTest {
    ...
    @Mock private MetricsRegistry metricsFactory;
    ...
    @BeforeEach
    void setUp() {
        ProjectIaaMetricsAdapter projectIaaMetricsAdapter = new ProjectIaaMetricsAdapter(
                projectParticipantRepository,
                datasetItemRepository,
                annotationRepository,
                new CalculateIaaMetricsService(metricsFactory));
        ProjectMetricsCalculator metricsCalculator = new ProjectMetricsCalculator(projectIaaMetricsAdapter);
    ...
    void getProjectMetricsShouldBuildContextAndReturnCompatibleMetrics() {
        ...
        ArgumentCaptor<IaaCalculationContext> contextCaptor =
                ArgumentCaptor.forClass(IaaCalculationContext.class);
