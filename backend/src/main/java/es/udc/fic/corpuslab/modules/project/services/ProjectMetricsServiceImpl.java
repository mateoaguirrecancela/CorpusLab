...
public class ProjectMetricsServiceImpl implements ProjectMetricsService {
    ...
    private void putXrrGroups(Map<String, Object> metadata, List<ProjectParticipant> annotators) {
        List<Long> groupAAnnotatorIds = annotatorIdsForGroupA(annotators);
        List<Long> groupBAnnotatorIds = annotatorIdsForGroupB(annotators);
    ...
    private List<Long> annotatorIdsForGroupA(List<ProjectParticipant> annotators) {
        return annotatorIdsForGroup(annotators, ProjectParticipantIaaGroup::isGroupA);
    }

    private List<Long> annotatorIdsForGroupB(List<ProjectParticipant> annotators) {
        return annotatorIdsForGroup(annotators, ProjectParticipantIaaGroup::isGroupB);
    }
