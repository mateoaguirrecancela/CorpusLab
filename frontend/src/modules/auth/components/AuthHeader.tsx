  ...
  return (
    <header className="border-b border-[color:var(--cl-line)] bg-white/85 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-3">
        <a href="/" className="group inline-flex items-center gap-2 text-[color:var(--cl-neutral)]">
        ...
        <nav className="flex items-center gap-3 text-sm font-medium">
          <a className="rounded-md px-3 py-1 text-[color:var(--cl-primary)] hover:bg-[color:var(--cl-primary-soft)]" href="/auth/login">
            Log In
          </a>
          <a href="/auth/signup">
